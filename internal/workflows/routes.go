...
var routes = []artifactRoute{
	...
	{Method: "POST", Path: "/v1/workflows/{workflowId}/executions/{executionId}:resume", RPC: "ResumeExecution", Body: "*", Reason: "user credential required"},
	{Method: "POST", Path: "/v1/workflows/{workflowId}/executions:start", RPC: "StartExecution", Body: "*", Reason: "user credential required"},
	...
	{Method: "POST", Path: "/v1/workflows/{workflowId}/triggers", RPC: "CreateWorkflowTrigger", Body: "trigger", Reason: "user credential required"},
