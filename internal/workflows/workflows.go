...
func newListCommand(f *cli.Factory) *cobra.Command {
	var limit int
	cmd := &cobra.Command{Use: "list", Short: "List workflows", SilenceUsage: true, SilenceErrors: true, Args: cobra.NoArgs}
...
func newGetCommand(f *cli.Factory) *cobra.Command {
	cmd := &cobra.Command{Use: "get WORKFLOW_ID", Short: "Get a workflow", SilenceUsage: true, SilenceErrors: true, Args: cobra.ExactArgs(1)}
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
...
func newCreateCommand(f *cli.Factory) *cobra.Command {
	...
	cmd := &cobra.Command{Use: "create [--name NAME | --input FILE]", Short: "Create a workflow", SilenceUsage: true, SilenceErrors: true, Args: cobra.NoArgs}
...
func newUpdateCommand(f *cli.Factory) *cobra.Command {
	var input string
	cmd := &cobra.Command{Use: "update WORKFLOW_ID --input FILE", Short: "Update a workflow", SilenceUsage: true, SilenceErrors: true, Args: cobra.ExactArgs(1)}
	cmd.Flags().StringVar(&input, "input", "", "JSON request body file, or - for stdin")
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
...
func newPublishCommand(f *cli.Factory) *cobra.Command {
	cmd := &cobra.Command{Use: "publish WORKFLOW_ID", Short: "Publish a workflow version", SilenceUsage: true, SilenceErrors: true, Args: cobra.ExactArgs(1)}
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
...
func newActivateCommand(f *cli.Factory) *cobra.Command {
	cmd := &cobra.Command{Use: "activate WORKFLOW_ID", Short: "Activate a workflow", SilenceUsage: true, SilenceErrors: true, Args: cobra.ExactArgs(1)}
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
...
func newDeactivateCommand(f *cli.Factory) *cobra.Command {
	cmd := &cobra.Command{Use: "deactivate WORKFLOW_ID", Short: "Deactivate a workflow", SilenceUsage: true, SilenceErrors: true, Args: cobra.ExactArgs(1)}
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
...
func newHistoryCommand(f *cli.Factory) *cobra.Command {
	cmd := &cobra.Command{Use: "history WORKFLOW_ID", Short: "Show workflow version history", SilenceUsage: true, SilenceErrors: true, Args: cobra.ExactArgs(1)}
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
