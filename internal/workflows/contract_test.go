...
var userOAuthCLIRoutes = []string{
	"POST /v1/workflows/{}/executions:start",
	"POST /v1/workflows/{}/executions/{}:resume",
	"POST /v1/workflows/{}/triggers",
}
...
func TestContractParity(t *testing.T) {
	...
	userOAuth := map[string]struct{}{}
	for _, key := range userOAuthCLIRoutes {
		userOAuth[key] = struct{}{}
	}
	...
	routepolicy.AssertCLICovered(t, idx, cliKeys)
